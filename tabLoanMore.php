            ...
            <form  method="post">
                ...
                <div class="addFormLine">
                    ...
                    <div class="lineRight">
                        ...
                        <input readonly="readonly" type="number" min="0" name="penalty_cost" value= '.$valueCol["penalty_cost"].' class="inputInfo" id="penaltyCost" placeholder="Penalty cost">
                    </div>
                </div>
